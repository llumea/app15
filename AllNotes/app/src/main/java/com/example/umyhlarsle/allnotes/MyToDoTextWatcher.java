 ...
 */
public class MyToDoTextWatcher implements TextWatcher {

    SecondActivity context;

    public MyToDoTextWatcher(SecondActivity context){
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (s.length()>25){
            ...
            Toast.makeText(context, "The title cannot exceed 25 characters",
